...
%% Thesis details
\thesistitle{pgx-lower: Bridging Modern Database Compiler Advances With Battle-Tested Database Systems}
...
\input{02_mainmatter/03_method}
\input{02_mainmatter/04_conclusion}
