...
\section{Code URLs}\label{appendix:code-urls}
\begin{itemize}
	\item Primary codebase \url{https://github.com/zyros-dev/pgx-lower}
	\item Deployed website \url{https://pgx.zyros.dev/query}
	\item This report's LaTeX files \url{https://github.com/zyros-dev/pgx-lower-report}
	\item The website's code \url{https://github.com/zyros-dev/pgx-lower-addons}
	\item Benchmarking from the literature review of this project \url{https://github.com/zyros-dev/benchmarking-dockers}
\end{itemize}
