...
these advances, query optimizers frequently produce suboptimal plans \cite{optimizer-bad-1,optimizer-bad-2}.
A list of optimisations would be long enough for a thesis to be written to summarise them.
...
% TODO: I need to talk about the genetic optimisations in postgresql here!
