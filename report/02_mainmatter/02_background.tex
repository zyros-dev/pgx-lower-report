...
caches are barely used. An i5-760, a popular CPU in 2010, had an 8\,MB L3 cache,
...
Most of the recent database research has focused on the optimiser,
...
it targets short-lived programs. The majority of JIT applications
...
PostgreSQL is released under the PostgreSQL Licence, a permissive BSD-like licence that
permits free modification, distribution, and commercial use without 
restriction \cite{postgresql_license}. This means editing it or creating 
commercial extensions is fair use.
