...
These observations led to the \emph{vectorized} and \emph{compiled execution models}. The vectorized model pulls multiple tuples
...
based on the situation, decisions often made by the optimiser \cite{effelsberg1984buffer}. Cache effectiveness is measured by \emph{last level cache hit rate} (LLC), which represents
...
re-implement common compiler optimisations, making it easier to build compilers~\cite{llvm-paper}. \emph{Multi-Level
