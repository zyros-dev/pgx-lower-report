...
Evaluating a good branch prediction value is difficult. A reasonable baseline is that a
$1\%$ misprediction rate is too high and should be optimised in a low latency environment
\cite{farrier2025branch}. This baseline is not formal; it is based on empirical knowledge
