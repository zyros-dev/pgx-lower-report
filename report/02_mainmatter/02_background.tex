...
These observations led to the vectorized and compiled execution models. With the vectorized model, multiple tuples are pulled
...
Compilation approaches will be explored in
...
making their queries 2.6x faster \cite{dbms-branches}. Azul's JIT compiler
