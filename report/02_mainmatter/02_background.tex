...
these advances, query optimisers frequently produce suboptimal plans \cite{optimizer-bad-1,optimizer-bad-2}. Another essential pattern to understand is genetic algorithms
are used inside of optimisers for things like join orders, which can
cause the outputted plan to be non-deterministic \cite{utesch1997geqo}.
A list of optimisations would be long enough for a thesis to be written to
summarise them.
...
such as eight kilobytes. This is loaded into a 
buffer pool object which holds it inside
...
this hybrid architecture is useful any more because putting pressure
