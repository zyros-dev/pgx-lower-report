...
these advances, query optimizers frequently produce suboptimal plans \cite{optimizer-bad-1,optimizer-bad-2}. Another essential pattern to understand is genetic algorithms
