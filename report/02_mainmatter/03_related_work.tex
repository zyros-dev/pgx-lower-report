...
2022 and claiming 20x revenue growth by 2024 \cite{timescale_2024_update}
...
PostgreSQL in 2017 \cite{postgres-pr-1,postgres-pr-2}. Doubts were expressed about adding full query compilation support, with concerns that
...
some of their queries ran 2,229x slower \cite{psql-jit-failure}. Such failures reinforced the view that JIT features should remain disabled by default,
...
A second implementation was presented at PgCon, achieving 5.5x speedup on TPC-H query 1
with more extensive documentation \cite{pgcon_jit_2017}. However, they did not publicize their implementation or show that it's easy for people to use.
...
was purchased by Tableau in 2016 to be used in production \cite{tableau-hyper}, proving that
...
A novel optimisation they introduced was enabling the compiler to
...
Such dynamic planning improved data-centric query runtimes by a factor of two. Other
...
less code than DuckDB and five times less than NoisePage.
