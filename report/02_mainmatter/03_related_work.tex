...
figure~\ref{fig:pprof-psql}. These queries were chosen because the Mutable
...
JIT
is improving the branch predictions. To measure this, \texttt{perf} was 
used on the same set of queries as shown in Table~\ref{tbl:prof-psql}. This
shows that
at worst, 43.02\% of LLC loads are missed. A 0.69\% branch miss rate has room 
