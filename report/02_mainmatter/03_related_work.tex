% TODO
% Need an overview of common OLAP databases
...
HyPer, and outperform them in many cases. While pushing Mutable to the
...
systems to invole, so a recreation of the benchmarks was done. DuckDB, HyPer,
...
of the involved pieces used it themselves \cite{tpch}, and docker containers were
...
To identify how much potential gain there is in a majory on-disk database,
\texttt{perf} was used on PostgreSQL during TPC-H queries 1, 3, 6, 12 and 14 in
figure~\ref{fig:pprof-psql}. This shows that the CPU time varied from between
34.87\% and 76.56\%, with an average of 49.32\%. These metrics were identified
...
As stated in subsection~\ref{subsec:jit_background}, one core acceleration of JIT
is improving the branch predictions. To measure this, \texttt{perf} was used
on the same set of queries as shown in Table~\ref{tbl:prof-psql}. This shows that
at worst, 43.02\% of LLC loads are missed. A 0.69\% branch miss rate has room for
improvement, as systems with even a 99\% branch prediction accuracy can
have a significant bottleneck from it.
% TODO what is an llc load, also TODO I need to go read about the context
% of this table; why did I only test q1, 3, 6, and 12?
