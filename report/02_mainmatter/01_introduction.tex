...
Research projects typically create standalone databases. However, this approach makes distribution
harder, requiring projects to implement all supporting infrastructure themselves.
For serious projects, this involves many additional implementation steps. To productionise the system, this might include implementing ACID,
