...
For serious projects, supporting infrastructure requires implementing ACID, MVCC, query plan optimisation, and more. By using an established database, we can
...
in Chapter~\ref{ch:project}. Conclusions are drawn in Chapter~\ref{ch:conclusion}.
