...
as well, which might require a large number of additional steps for serious
...
pgx-lower replaces PostgreSQL's execution engine with a LingoDB's compiler
...
Chapter~\ref{ch:lit-survey}. The project's solution will
