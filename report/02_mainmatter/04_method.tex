...
unneeded features and optimisations, so the 2022 version from their initial paper was selected to simplify implementation
effort.
...
The scope included 94 operations total across all dialects (93 in LingoDB, 94 in pgx-lower)
