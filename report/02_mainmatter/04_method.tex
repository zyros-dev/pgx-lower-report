% TODO 
% 1. add a sentence about postgres optimisations to prevent misunderstandings about them being skipped 
...
section~\ref{todo}. The primary challenge with this is that LingoDB is a columnar,
...
Within the index scan it has specific annotations for variables with its |INDEX\_VAR|
