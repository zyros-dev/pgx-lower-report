...
LLVM, such as sorting algorithms. \texttt{pgx-lower} implemented reading tuples from
...
then a recursive descent parser starts translating. Within
each translation function, the pattern is typically: the children
of the plan are translated (post-order traversal), then the node
is translated into the MLIR relational algebra dialect, and a "translation result" is returned.
