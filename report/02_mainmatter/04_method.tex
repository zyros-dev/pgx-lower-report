...
process. This means there are several debugging layers to navigate: the PostgreSQL
postmaster, the client connection, the runtime hook entrance, C++ code, and the JIT runtime.
