...
JIT systems, and not short-lived queries. While WebAssembly is appealing here
because it targets short-lived processes, we would not be able
to inline functions in the future. Either way, switching to a different
compiler, or away from C++ into C or Rust is appealing. With C, the
LLVM API is more stable and in Rust the memory safety and correctness can be improved.
