...
this, but it is a vectorised engine. Alternatively, to target research 
compilers this can be done with Mutable or a WebAssembly-based compiler for 
PostgreSQL queries can be written from scratch using these techniques.
