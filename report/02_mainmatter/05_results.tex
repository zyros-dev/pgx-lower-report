...
only 14.93\,milliseconds occurs in \texttt{llvm::SelectionDAGISel::runOnMachineFunction}, the LLVM IR to machine code conversion step. Total compilation
time reaches 236.32\,milliseconds, with most spent in MLIR passes. These results suggest
...
median branches, while pgx-lower had 195,299,021.50 ($6.87\times$ more).
...
making higher throughput less critical. Practically, latency gains more often come from application-level caching (such as Redis) than database optimization.
