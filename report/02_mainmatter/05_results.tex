...
(as in figure~\ref{fig:bench-mem-diff-plots}), arrow annotations are used instead. Matplotlib and Seaborn generated
all visualizations in Python.
...
Such similarity demonstrates successful adaptation of LingoDB's in-memory operations to PostgreSQL's disk-oriented architecture. Maximum difference is just over 3 megabytes, with a mean difference of 0.34 megabytes across all queries.
